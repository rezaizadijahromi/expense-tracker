...
router.route("/category").post(expenseControllers_1.createCategory).get(expenseControllers_1.getAllCategory);
...
router
    ...
    .get(authMiddleWare_1.protect, expenseControllers_1.averageCategories)
    .post(authMiddleWare_1.protect, expenseControllers_1.averageCategories);
